...
@Component(
	immediate = true,
	property = {
		"context.id=ShareITCustomJspBag",
		"context.name=Share IT Custom JSP Bag",
		"service.ranking:Integer=100"
	}
)
public class ShareITCustomJspBag implements CustomJspBag {
	...
	/**
	 * Adds the URL paths for all custom core JSPs to a list when the module is activated.
	 *
	 * @param bundleContext the bundle context from which to get the custom JSP's bundle
	 */
	@Activate
